...
* The `oc_authtoken` table's login name column size has been increased. The impact depends on the number of recently logged in users, and the number of app passwords that have been created.
