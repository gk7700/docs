...
With ownCloud Server 10.2, a new permission for public links on folders is available for users. 
The new permission is named `Download / View / Edit`, and replaces the former `Download / View / Upload`.
It lets recipients view, download, and upload documents, while preventing them from making changes (e.g., rename, move, collaborative editing). 
Another way of looking at it is a public file drop for distributing and gathering information with a single link, while preventing recipients from changing contents.
